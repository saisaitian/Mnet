...
def ToDict(fp, Net, key_col=0, val_col=1, has_header=True, encoding="utf-8"):
    mapping = {}
    with open(fp, newline="", encoding=encoding) as fi:
...
if __name__ == "__main__":
    ...
    FILE1 = " TCM ingredient2targets.csv"
    REPEAT = 1000
    MEASURE = "CLOSEST"
    ...
    for i, FILE2 in enumerate(input_files):
        ...
        print(f"Finished processing {FILE2}, results saved in {OUTPUT}")
